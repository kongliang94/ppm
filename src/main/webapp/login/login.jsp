						...
						<div class="position-relative">
							<div id="login-box"
								...
								<div class="widget-body">
										...
										<form action="loginAction_login.action" method="post">
											<fieldset>
												<label class="block clearfix"> <span
													...
													<input
														type="text" name="logonname" class="form-control" placeholder="用户名" /> <i
														class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" name="logonpwd" class="form-control" placeholder="密码" />
														<i class="icon-lock"></i>
												</span>
												</label>
									...
									<!-- /widget-main -->
									<div id="loginInfo" style="margin-top:12px;font-size:18px;color:red;text-align:center"></div>
							...
							<div id="signup-box" class="signup-box widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form action="${pageContext.request.contextPath}/regUserAction" method="post">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
									...
									<div id="regInfo" style="margin-top:12px;font-size:12px;color:red;text-align:center"></div>
									<div class="toolbar center">
										<a href="#" onclick="show_box('login-box'); return false;"
	...
	<script type="text/javascript">
		...
		<script type="text/javascript">
			...
			if(result=="1"){
				...
				document.getElementById("regInfo").innerHTML="重复提交";
			}
			else if(result=="2"){
