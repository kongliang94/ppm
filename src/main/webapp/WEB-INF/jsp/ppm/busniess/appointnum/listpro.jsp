		...
		<div class="nav navbar-pink" id="navbar-container">
			...
			<div id="navbar" class="navbar-header pull-right">
				...
				<ul id="myTab"
					...
					<li class="active"><a href="${pageContext.request.contextPath}/projectAction_showAppointNumPageResult.action">指定项目编号</a></li>
						...
						<div class="table-responsive">
							<table id="sample-table-1"
								...
								<s:iterator value="#projects" var="p">
									<tbody>
										<tr>
											<td class="center"><a href="projectAction_appointUI.action?pid=${pid}">指定</a></td>
