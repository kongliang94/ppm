...
$(function() {
    ...
    $("#uploader").pluploadQueue({
        ...
        url : '${pageContext.request.contextPath}/fileAction_upload.action',
       // chunk_size : '1mb',
        unique_names : true,
        ...
        init : {
            ...
            BeforeUpload: function(up, file) {
               ...
               // log('[BeforeUpload]', 'File: ', file);
            	up.setOption('url','${pageContext.request.contextPath}/fileAction_upload.action?filePath=${param.filePath}&pid=${param.pid}&stage=${param.stage}'); 
            },
            ...
            UploadComplete: function(up, files) {
               ...
               //parent.window('close');
               if (confirm("上传成功！")) {
               	window.parent.location.href="${pageContext.request.contextPath}/projectAction_updateUI.action?pid="+${param.pid};				
				} 
