		...
		<div class="nav navbar-pink" id="navbar-container">
			...
			<div id="navbar" class="navbar-header pull-right">
				...
				<ul id="myTab"
					...
					<li class="active"><a href="${pageContext.request.contextPath}/projectAction_showApproveProjectList.action">审批</a>
					</li>

					<li><a href="#">数据下载</a>
					</li>
					<li><a href="#"><h5>欢迎您：${sessionScope.user.username}</h5></a>
					</li>
				</ul>
			</div>
		</div>
						...
						<div class="table-responsive">
							<table id="sample-table-1"
								...
								<s:iterator value="#projects" var="p">
									<tbody>
										<tr>
											<td class="center"><a href="projectAction_approveUI.action?pid=${pid}">审批</a></td>
